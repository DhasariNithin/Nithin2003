namespace Nithin2003.Models
{
    public class Sale
    {
        ...
        private static List<string> COUNTRIES = new List<string> {  "Japan", "China", "France", "German", "US", "UK", "Canada", "Italy", "Korea", "Australia" };
        private static List<string> PRODUCTS = new List<string> { "Widget", "Gadget", "Doohickey" };

        
        public static IEnumerable<Sale> GetData(int total)
        {
            var colors = new[] { "White", "Green", "Red", "Black", "Blue" };
